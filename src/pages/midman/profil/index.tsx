...
import { User, Image as ImageIcon, Clock, Edit2, LogOut } from "lucide-react";
  ...
  return (
    <div className="min-h-screen pt-13 bg-gray-100 text-gray-900">
      ...
      <div className="p-6 bg-white shadow-md relative">
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-semibold">Nama Midman</h2>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 px-6">
        <h3 className="font-semibold mb-4 text-center">Aktivitas</h3>
        <div className="pl-100 justify-center">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            {/* Semua Transaksi */}
            <div
              onClick={() => navigateTo("semuaTransaksi")}
              className="flex flex-col items-center bg-white p-4 rounded shadow hover:bg-gray-50 transition cursor-pointer hover:shadow-md"
            >
              <Clock size={32} className="mb-2" />
              <p className="text-sm text-center">Semua Transaksi</p>
            </div>
          </div>
        </div>
      </div>
