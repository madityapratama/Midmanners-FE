  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-white p-6 mt-10">
      <div className="w-full max-w-md bg-gray-400 p-6 rounded-lg shadow-md font-poppins text-indigo-950 relative">
        ...
        <h2 className="text-center text-xl font-semibold mb-6 mt-2">Detail Pengajuan Menjadi Seller</h2>

        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium">Nama User</label>
            <input value={data.username} readOnly className="w-full p-2 rounded bg-white" />
          </div>

          <div>
            <label className="block text-sm font-medium">Metode Pembayaran</label>
            <input value={data.metode} readOnly className="w-full p-2 rounded bg-white" />
          </div>

          <div>
            <label className="block text-sm font-medium">Nama Bank / E-Wallet</label>
            <input value={data.bank} readOnly className="w-full p-2 rounded bg-white" />
          </div>

          <div>
            <label className="block text-sm font-medium">No Rek. / E-Wallet</label>
            <input value={data.norek} readOnly className="w-full p-2 rounded bg-white" />
          </div>

          <div>
            <label className="block text-sm font-medium">NIK</label>
            <input value={data.nik} readOnly className="w-full p-2 rounded bg-white" />
          </div>

          <div>
            <label className="block text-sm font-medium mb-2">KTP</label>
            <img src={data.ktpUrl} alt="Foto KTP" className="w-32 h-20 object-cover rounded border" />
          </div>
        </div>
