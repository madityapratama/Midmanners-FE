            ...
            >
              ...
              <div className="px-3 sm:px-4 py-2 sm:py-3 border-t border-gray-100 flex justify-between gap-2 sm:gap-0">
                <div className="flex space-x-3 sm:space-x-4">
                  ...
                  >
                    <ThumbsUp className={`w-4 h-4 sm:w-5 sm:h-5 ${isLiked ? 'fill-indigo-600' : ''}`} />
                    <span className="text-xs sm:text-sm">{post.like_count} Likes</span>
                  </motion.button>

                  <button className="flex items-center space-x-1 sm:space-x-2 text-gray-500 hover:text-indigo-600 transition-colors">
                    <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5" />
                    <span className="text-xs sm:text-sm">{post.comment_count} Comments</span>
                  </button>
                </div>
