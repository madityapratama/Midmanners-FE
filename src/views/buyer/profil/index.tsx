    ...
    {profile?.role === "buyer" && (
      <div className="flex flex-col items-end gap-2">
        <div>
          ...
          {profile?.status_pengajuan_seller === "rejected" && (
            <p className="px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">
              Pengajuan Anda ditolak karena {profile?.alasan_penolakan_pengajuan_seller}
            </p>
          )}
          {profile?.status_pengajuan_seller === "pending" && (
